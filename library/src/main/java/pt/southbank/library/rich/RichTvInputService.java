...
package pt.southbank.library.rich;
...
import pt.southbank.library.BaseTvInputService;
import pt.southbank.library.EpgSyncJobService;
import pt.southbank.library.R;
import pt.southbank.library.TvContractUtils;
import pt.southbank.library.TvPlayer;
import pt.southbank.library.democomponents.SampleJobService;
import pt.southbank.library.models.Advertisement;
import pt.southbank.library.models.Channel;
import pt.southbank.library.models.InternalProviderData;
import pt.southbank.library.models.Program;
import pt.southbank.library.models.RecordedProgram;
import pt.southbank.library.player.DemoPlayer;
import pt.southbank.library.player.RendererBuilderFactory;
...
public class RichTvInputService extends BaseTvInputService {
    ...
    class RichTvInputSessionImpl extends BaseTvInputService.Session implements
        ...
        public boolean onPlayProgram(Program program, long startPosMs) {
            ...
            if (internalProviderData == null) return false;
