...
public abstract class BaseTvInputService extends TvInputService {
    ...
    public static final String PREFERENCES_FILE_KEY =
            "com.google.android.media.library";
    /**
    ...
    /**
     * A {@link Session} is called when a user tunes to channel provided by
    ...
    /**
     * A {@link RecordingSession} is created when a user wants to begin recording
